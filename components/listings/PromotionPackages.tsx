  ...
  const renderPackageCard = (pkg: PackageItem) => {
    ...
    return (
      ...
      >
        ...
        <p className="text-gray-500 text-[11px] leading-tight line-clamp-2 mb-4 h-8">
            {pkg.description || (pkg.intervalDay ? `${pkg.intervalDay} günlük xidmət paketi` : 'Elanınızı irəli çəkin')}
        </p>

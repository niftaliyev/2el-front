...
export default function CategoryCard({ category }: CategoryCardProps) {
  return (
    ...
    >
      <div className="flex items-center justify-center w-20 h-20 bg-white border-2 border-gray-200 rounded-full group-hover:bg-primary group-hover:border-primary group-hover:shadow-lg transition-all duration-200 overflow-hidden px-1">
        {category.image ? (
          <img 
            src={category.image} 
            alt={category.name} 

...
export default function Header() {
  ...
  return (
    <header className={`w-full bg-white border-b border-solid border-gray-200 sticky top-0 z-[100] transition-transform duration-300 ease-in-out md:translate-y-0 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
      {/* ─── Main Row ─── */}

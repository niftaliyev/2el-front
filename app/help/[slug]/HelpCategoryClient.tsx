...
export default function HelpCategoryClient({ initialData, slug }: { initialData: HelpCategory | null; slug: string }) {
  const { language } = useLanguage();
  const [category, setCategory] = useState<HelpCategory | null>(initialData);

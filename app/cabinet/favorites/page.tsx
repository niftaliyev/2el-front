        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1 overflow-hidden">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-3 sm:p-8">
              {/* Page Heading */}
              <div className="mb-4 sm:mb-8 border-b border-gray-50 pb-4 sm:pb-6">
                <h1 className="text-gray-900 text-2xl sm:text-4xl font-bold leading-tight tracking-tight mb-1 sm:mb-2 ml-1 sm:ml-0">
                  Seçilmişlərim
                </h1>
                <p className="text-gray-500 text-[11px] sm:text-sm font-medium ml-1 sm:ml-0">

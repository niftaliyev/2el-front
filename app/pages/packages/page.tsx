  ...
  return (
    <div className="space-y-10">
      ...
      <div className="space-y-12">
        ...
        {/* VIP Ads */}
        <section className="flex flex-col md:flex-row gap-6">
          <div className="size-16 sm:size-20 bg-blue-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border border-blue-100">
            <span className="material-symbols-outlined !text-4xl text-blue-600">stars</span>
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-3 flex items-center gap-2">
              {t('listings.vipAds')}
              <span className="bg-blue-600 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded">VIP</span>
            </h2>
            <p className="text-gray-600 leading-relaxed font-medium mb-4">
            ...
            {t('paidServices.vip.bonus') && (
              <div className="inline-flex items-center gap-2 bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-100 text-blue-700 text-xs font-black">
                <span className="material-symbols-outlined !text-sm">redeem</span>
                {t('paidServices.vip.bonus')}
              </div>
            )}
        ...
        {/* Premium Ads */}
        <section className="flex flex-col md:flex-row gap-6">
          <div className="size-16 sm:size-20 bg-yellow-50 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border border-yellow-100">
            <span className="material-symbols-outlined !text-4xl text-yellow-600">workspace_premium</span>
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-3 flex items-center gap-2">
              {t('promoteModal.premium')}
              <span className="bg-yellow-500 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded">PREMIUM</span>
            </h2>
            <p className="text-gray-600 leading-relaxed font-medium mb-4">
